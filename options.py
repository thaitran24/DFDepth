...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "oxford_all", "oxford_day"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--use_day_pose",
                                 help="if set, use day pose for night image",
                                 action="store_true")
        self.parser.add_argument("--lambda_depth_sim",
                                 type=float,
                                 help="lambda depth similarity loss",
                                 default=1.0)
        self.parser.add_argument("--lambda_feat_sim",
                                 type=float,
                                 help="lambda feature similarity loss",
                                 default=1.0)
